...
def main(_argv):
    ...
    for count, image_path in enumerate(images, 1):
        print(count)
        if(image_path.split(".")[-1] != "jpg"): continue
        ...
        if FLAGS.crop:
            ...
            crop_objects(cv2.cvtColor(original_image, cv2.COLOR_BGR2RGB), pred_bbox, crop_path, "KWH", image_name)
        ...
        cv2.imwrite(FLAGS.output + 'detection' + image_name + '.png', image)
